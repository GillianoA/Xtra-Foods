...
<div class="wp-block-group">
	...
	<div class="wp-block-group has-background" style="background-color:#254094;padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)">
		...
		<p class="has-text-color" style="color:#ffffff;font-size:35px;font-style:normal;font-weight:300"><br>
<b>Fatal error</b>:  Uncaught Error: Call to undefined function esc_html() in C:\xampp\htdocs\Xtra-Foods\wp-content\plugins\woocommerce\patterns\discount-banner.php:24
Stack trace:
#0 {main}
  thrown in <b>C:\xampp\htdocs\Xtra-Foods\wp-content\plugins\woocommerce\patterns\discount-banner.php</b> on line <b>24</b><br>
</p>
</div>
</div>