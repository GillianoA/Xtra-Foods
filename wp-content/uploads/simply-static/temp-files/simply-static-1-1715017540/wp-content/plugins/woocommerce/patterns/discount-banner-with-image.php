...
<div class="wp-block-columns alignwide are-vertically-aligned-center has-background" style="background-color:#254094;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px">
	...
	<div class="wp-block-column is-vertically-aligned-center">
		...
		<div class="wp-block-group" style="padding-top:15px">
			...
			<p class="has-text-color" style="color:#ffffff;margin-bottom:40px;font-size:35px;font-style:normal;font-weight:300;line-height:0"><br>
<b>Fatal error</b>:  Uncaught Error: Call to undefined function esc_html() in C:\xampp\htdocs\Xtra-Foods\wp-content\plugins\woocommerce\patterns\discount-banner-with-image.php:28
Stack trace:
#0 {main}
  thrown in <b>C:\xampp\htdocs\Xtra-Foods\wp-content\plugins\woocommerce\patterns\discount-banner-with-image.php</b> on line <b>28</b><br>
</p>
</div>
</div>
</div>