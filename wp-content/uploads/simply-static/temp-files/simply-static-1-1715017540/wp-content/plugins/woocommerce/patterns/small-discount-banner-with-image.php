...
<div class="wp-block-columns has-background" style="background-color:#fcf8e1;padding-top:20px;padding-right:20px;padding-bottom:20px;padding-left:20px">
	...
	<div class="wp-block-column" style="flex-basis:45%">
		...
		<div class="wp-block-group" style="margin-top:0;padding-top:25px;padding-left:25px">
			...
			<p style="font-size:30px;font-style:normal;font-weight:300;line-height:1"><em><br>
<b>Fatal error</b>:  Uncaught Error: Call to undefined function esc_html() in C:\xampp\htdocs\Xtra-Foods\wp-content\plugins\woocommerce\patterns\small-discount-banner-with-image.php:20
Stack trace:
#0 {main}
  thrown in <b>C:\xampp\htdocs\Xtra-Foods\wp-content\plugins\woocommerce\patterns\small-discount-banner-with-image.php</b> on line <b>20</b><br>
</em></p>
</div>
</div>
</div>