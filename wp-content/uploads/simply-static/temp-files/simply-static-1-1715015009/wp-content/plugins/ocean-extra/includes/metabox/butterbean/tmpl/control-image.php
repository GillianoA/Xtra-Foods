...
<# if ( data.src ) { #>
	<img class="butterbean-img" src="https://gillianoa.github.io/Xtra-Foods/wp-content/plugins/ocean-extra/includes/metabox/butterbean/tmpl/{{ data.src }}" alt="{{ data.alt }}">
<# } else { #>
	</p>
